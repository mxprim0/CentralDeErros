    ...
    public class CentralContext : DbContext,IDisposable
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
                optionsBuilder.UseSqlServer("Data Source=Server=http://centraldeerros.database.windows.net;Database=CentralDeErros;User Id =ADM;Password=Squad@03;Trusted_Connection=False;");
        }
